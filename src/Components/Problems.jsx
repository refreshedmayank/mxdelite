function Problems() {
  return (
    <div>
      <div className="mt-12 flex flex-col justify-center items-center p-5 bg-black text-xl text-center  gap-">
      ...
      <div className="flex flex-col gap-6 text-lg ">
        ...
        <div className="border rounded-md border-bwhite/20 p-3">
          <span>Business</span>
          <h3>
